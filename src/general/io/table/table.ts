...
//  - ratio columns could split too! into a numerator, slash, and denominator column
//  With both ratios and monzos handled thusly, we might be closer than we think
