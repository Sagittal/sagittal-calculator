...
const computeNumeratorMonzosToCheckGivenMaxN2D3P9 = (maxN2D3P9: Max<N2D3P9>): Monzo[] => {
    ...
    const numeratorPrimeExponentExtremaGivenMaxN2D3P9: Array<Extrema<Exponent<Prime>>> = maxNumeratorPrimeExponentsGivenMaxN2D3P9.map(maxNumeratorPrimeExponentGivenMaxN2D3P9 => {
