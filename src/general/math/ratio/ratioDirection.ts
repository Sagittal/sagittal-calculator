...
import { Denominator, FractionalPart, Numerator, PotentiallyNonintegerRatioParameter, Ratio } from "./types"

const computeIsSuperRatio = <T extends NumericTypeParameters>(
    ratio: PotentiallyNonintegerRatioParameter<Omit<T, "direction">>,
...
const computeSuperRatio = <T extends NumericTypeParameters>(
    ratio: PotentiallyNonintegerRatioParameter<T>,
