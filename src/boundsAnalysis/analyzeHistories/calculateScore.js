...
const calculateBinaryScoreRepresentationIndex = (rank, levelIndex) => {
...
const calculateScore = analyzedHistories => {
    ...
    analyzedHistories.forEach(analyzedHistory => {
        const binaryScoreRepresentationIndex = calculateBinaryScoreRepresentationIndex(analyzedHistory.rank, LEVELS.indexOf(analyzedHistory.level))
...
module.exports = {
    calculateScore,
    calculateBinaryScoreRepresentationIndex,
}
