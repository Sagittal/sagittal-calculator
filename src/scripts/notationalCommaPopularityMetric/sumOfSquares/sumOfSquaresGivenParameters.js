...
const computeSumOfSquaresGivenParameters = (parameters, {logOurApproximatePopularities}) => {
    ...
    if (logOurApproximatePopularities) console.log(ourApproximatePopularities)
