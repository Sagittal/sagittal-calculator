...
const analyzePopular23FreeClassWithBestNotatingComma = (
    ...
    const commaWithMaybeSagittalSymbolClassId = addMaybeJiNotationSymbolClassId(bestNotatingComma)
    ...
    return {
        ...
        popularityRank,
        votes,
        centsOfBestNotatingComma: formatNumber(computeCentsFromPitch(commaWithMaybeSagittalSymbolClassId)),
        monzoOfBestNotatingComma: formatMonzo(computeJiPitchMonzo(commaWithMaybeSagittalSymbolClassId)),
