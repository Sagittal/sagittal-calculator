import { colorize, ColorMethod, Count, IntegerDecimal, Io, Rank } from "../../../../../general"
...
const formatRankAnalysis = (rankCount: Count<IntegerDecimal & Rank<BoundType>>, rank: number): Io => {
