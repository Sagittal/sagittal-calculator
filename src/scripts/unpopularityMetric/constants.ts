import { Count, Unit, Exponent } from "../../general"
import { ParameterValue, Popularity } from "./sumOfSquares"
import { PopularityRank, UnpopularityRank } from "./sumOfSquares/types"
