...
const computeFiveMonzosToCheck = ({maximumPrimeLimit, maximumSopfgtt, maximumCopfgtt} = {}) => {
    ...
    const indexOfMaximumPrime = PRIMES.findIndex(prime => prime === maximumPrime)
    ...
    primes.forEach(prime => {
        ...
        fiveMonzosToCheck.forEach(fiveMonzoToCheck => {
            ...
            const termRange = computeTermRange(prime, {maximumSopfgtt: maximumSopfgtt ? maximumSopfgtt - sopfgtt : undefined, maximumCopfgtt})
