...
const computeCommasFrom23FreeMonzo = (
    ...
    computePlusOrMinusRange(maxAte).forEach((threeExponent: 3 & Integer & Exponent<Prime>): void => {
        ...
        if (monzo) {
            ...
            if (abs(commaAnalysis.apotomeSlope) > maxAas || commaAnalysis.n2d3p9 > maxN2D3P9) {
                return
            }
