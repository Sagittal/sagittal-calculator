...
// TODO: should these include their types? per the bounds analysis?
//  if they do, there should probably be some test, in the bounds analysis script group, that it matches
