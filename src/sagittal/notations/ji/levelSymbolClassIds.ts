...
const MEDIUM_LEVEL_SYMBOL_CLASS_IDS = [0, 12, 20, 30, 44, 58, 70, 85, 93, 105, 115, 132, 142] as Array<Id<SymbolClass>>

const HIGH_LEVEL_SYMBOL_CLASS_IDS = sort(MEDIUM_LEVEL_SYMBOL_CLASS_IDS.concat(
    [
        ...
        67, 76, 82, 87, 100, 107, 118, 123, 129, 140, 147] as Array<Id<SymbolClass>>,
))

const ULTRA_LEVEL_SYMBOL_CLASS_IDS = sort(HIGH_LEVEL_SYMBOL_CLASS_IDS.concat([
    3, 4, 14, 16, 24, 26, 40, 47, 48, 54, 62, 66,
    74, 80, 81, 89, 97, 109, 111, 120, 127, 136, 138,
] as Array<Id<SymbolClass>>))

const EXTREME_LEVEL_SYMBOL_CLASS_IDS = sort(ULTRA_LEVEL_SYMBOL_CLASS_IDS.concat([
...
const INSANE_LEVEL_SYMBOL_CLASS_IDS = sort(EXTREME_LEVEL_SYMBOL_CLASS_IDS
    .concat([]))
