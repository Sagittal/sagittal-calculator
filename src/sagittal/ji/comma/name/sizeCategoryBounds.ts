import { Decimal, Name, RationalMonzo } from "../../../../general"
...
const SIZE_CATEGORY_BOUNDS: SizeCategoryBound[] = [
    {
        ...
        monzo: [] as unknown[] as RationalMonzo<{ irrational: true }>,
    },
    {
        name: "n|s" as Name<SizeCategoryBound>,
        decimal: 1.0010446114140399 as Decimal,                             // 1.80752293276652¢
        monzo: [-42, 26.5] as RationalMonzo<{ irrational: true }>,
    },
    {
