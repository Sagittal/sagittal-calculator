...
import {ArmId, Flacco, FlaccoId, HeadId, Orientation} from "./types"
...
const FLACCOS: Record<FlaccoId, Flacco> = {
    ...
    /*3*/[FlaccoId.TICK_AGAINST_LEFT_SCROLL]: {
        arm: getArm(ArmId.TICK, Orientation.AGAINST),
        core: getHead(HeadId.LEFT_SCROLL),
    },
    /*4*/[FlaccoId.TICK]: {
    ...
    /*8*/[FlaccoId.WING_WITH_LEFT_SCROLL]: {
        arm: getArm(ArmId.WING),
        core: getHead(HeadId.LEFT_SCROLL),
    },
    /*9*/[FlaccoId.BIRD_WITH_LEFT_SCROLL]: {
        arm: getArm(ArmId.BIRD),
        core: getHead(HeadId.LEFT_SCROLL),
    },
    /*10*/[FlaccoId.BIRD_AGAINST_RIGHT_SCROLL]: {
        arm: getArm(ArmId.BIRD, Orientation.AGAINST),
        core: getHead(HeadId.RIGHT_SCROLL),
    },
    ...
    /*13*/[FlaccoId.WING_WITH_RIGHT_SCROLL]: {
        arm: getArm(ArmId.WING),
        core: getHead(HeadId.RIGHT_SCROLL),
    },
    /*14*/[FlaccoId.TICK_AGAINST_LEFT_BOATHOOK]: {
        arm: getArm(ArmId.TICK, Orientation.AGAINST),
        core: getHead(HeadId.LEFT_BOATHOOK),
    },
    /*15*/[FlaccoId.WING_FROM_TICK_WITH_RIGHT_SCROLL]: {
        arm: getArm(ArmId.WING_FROM_TICK),
        core: getHead(HeadId.RIGHT_SCROLL),
    },
    /*16*/[FlaccoId.TICK_WITH_RIGHT_SCROLL]: {
        arm: getArm(ArmId.TICK),
        core: getHead(HeadId.RIGHT_SCROLL),
    },
    ...
    /*19*/[FlaccoId.WING_AGAINST_DOUBLE_SCROLL]: {
        arm: getArm(ArmId.WING, Orientation.AGAINST),
        core: getHead(HeadId.DOUBLE_SCROLL),
    },
    /*20*/[FlaccoId.DOUBLE_SCROLL]: {
        core: getHead(HeadId.DOUBLE_SCROLL),
    },
    /*21*/[FlaccoId.WING_WITH_DOUBLE_SCROLL]: {
        arm: getArm(ArmId.WING),
        core: getHead(HeadId.DOUBLE_SCROLL),
    },
    /*22*/[FlaccoId.BIRD_WITH_DOUBLE_SCROLL]: {
        arm: getArm(ArmId.BIRD),
        core: getHead(HeadId.DOUBLE_SCROLL),
    },
    /*23*/[FlaccoId.WING_FROM_TICK_WITH_DOUBLE_SCROLL]: {
        arm: getArm(ArmId.WING_FROM_TICK),
        core: getHead(HeadId.DOUBLE_SCROLL),
    },
    /*24*/[FlaccoId.TICK_WITH_DOUBLE_SCROLL]: {
        arm: getArm(ArmId.TICK),
        core: getHead(HeadId.DOUBLE_SCROLL),
    },
    /*25*/[FlaccoId.LEFT_SCROLL_AND_BOATHOOK]: {
        core: getHead(HeadId.LEFT_SCROLL_AND_BOATHOOK),
    },
    /*26*/[FlaccoId.TICK_AGAINST_BOATHOOK_AND_SCROLL]: {
        arm: getArm(ArmId.TICK, Orientation.AGAINST),
        core: getHead(HeadId.BOATHOOK_AND_SCROLL),
    },
    /*27*/[FlaccoId.WING_FROM_TICK_AGAINST_BOATHOOK_AND_SCROLL]: {
    ...
    /*31*/[FlaccoId.WING_WITH_BOATHOOK_AND_SCROLL]: {
        arm: getArm(ArmId.WING),
        core: getHead(HeadId.BOATHOOK_AND_SCROLL),
    },
    /*32*/[FlaccoId.BIRD_AGAINST_RIGHT_BOATHOOK]: {
        arm: getArm(ArmId.BIRD, Orientation.AGAINST),
        core: getHead(HeadId.RIGHT_BOATHOOK),
    },
    ...
    /*35*/[FlaccoId.WING_WITH_RIGHT_BOATHOOK]: {
        arm: getArm(ArmId.WING),
        core: getHead(HeadId.RIGHT_BOATHOOK),
    },
    /*36*/[FlaccoId.DOUBLE_LEFT_BOATHOOK]: {
        core: getHead(HeadId.DOUBLE_LEFT_BOATHOOK),
    },
    /*37*/[FlaccoId.WING_WITH_DOUBLE_LEFT_BOATHOOK]: {
        arm: getArm(ArmId.WING),
        core: getHead(HeadId.DOUBLE_LEFT_BOATHOOK),
    },
    /*38*/[FlaccoId.BIRD_WITH_DOUBLE_LEFT_BOATHOOK]: {
        arm: getArm(ArmId.BIRD),
        core: getHead(HeadId.DOUBLE_LEFT_BOATHOOK),
    },
    /*39*/[FlaccoId.WING_AND_TICK_AGAINST_LEFT_BARB]: {
        arm: getArm(ArmId.WING_AND_TICK, Orientation.AGAINST),
        core: getHead(HeadId.LEFT_BARB),
    },
    ...
    /*41*/[FlaccoId.SCROLL_AND_BOATHOOK]: {
        core: getHead(HeadId.SCROLL_AND_BOATHOOK),
    },
    ...
    /*45*/[FlaccoId.WING_WITH_LEFT_BARB]: {
        arm: getArm(ArmId.WING),
        core: getHead(HeadId.LEFT_BARB),
    },
    /*46*/[FlaccoId.BIRD_WITH_LEFT_BARB]: {
        arm: getArm(ArmId.BIRD),
        core: getHead(HeadId.LEFT_BARB),
    },
    /*47*/[FlaccoId.TICK_AGAINST_LEFT_SCROLL_AND_BARB]: {
        arm: getArm(ArmId.TICK, Orientation.AGAINST),
        core: getHead(HeadId.LEFT_SCROLL_AND_BARB),
    },
    /*48*/[FlaccoId.TICK_WITH_LEFT_BARB]: {
        arm: getArm(ArmId.TICK),
        core: getHead(HeadId.LEFT_BARB),
    },
    /*49*/[FlaccoId.WING_AND_TICK_WITH_LEFT_BARB]: {
        arm: getArm(ArmId.WING_AND_TICK),
        core: getHead(HeadId.LEFT_BARB),
    },
    ...
    /*53*/[FlaccoId.WING_AND_TICK_AGAINST_RIGHT_ARC]: {
        arm: getArm(ArmId.WING_AND_TICK, Orientation.AGAINST),
        core: getHead(HeadId.RIGHT_ARC),
    },
    /*54*/[FlaccoId.TICK_AGAINST_RIGHT_ARC]: {
        arm: getArm(ArmId.TICK, Orientation.AGAINST),
        core: getHead(HeadId.RIGHT_ARC),
    },
    /*55*/[FlaccoId.WING_FROM_TICK_AGAINST_RIGHT_ARC]: {
        arm: getArm(ArmId.WING_FROM_TICK, Orientation.AGAINST),
        core: getHead(HeadId.RIGHT_ARC),
    },
    ...
    /*59*/[FlaccoId.WING_WITH_RIGHT_ARC]: {
        arm: getArm(ArmId.WING),
        core: getHead(HeadId.RIGHT_ARC),
    },
    /*60*/[FlaccoId.BIRD_WITH_RIGHT_ARC]: {
        arm: getArm(ArmId.BIRD),
        core: getHead(HeadId.RIGHT_ARC),
    },
    /*61*/[FlaccoId.WING_FROM_TICK_WITH_RIGHT_ARC]: {
        arm: getArm(ArmId.WING_FROM_TICK),
        core: getHead(HeadId.RIGHT_ARC),
    },
    /*62*/[FlaccoId.TICK_WITH_RIGHT_ARC]: {
        arm: getArm(ArmId.TICK),
        core: getHead(HeadId.RIGHT_ARC),
    },
    /*63*/[FlaccoId.WING_AND_TICK_WITH_RIGHT_ARC]: {
        arm: getArm(ArmId.WING_AND_TICK),
        core: getHead(HeadId.RIGHT_ARC),
    },
    /*64*/[FlaccoId.WING_AGAINST_SCROLL_AND_ARC]: {
        arm: getArm(ArmId.WING, Orientation.AGAINST),
        core: getHead(HeadId.SCROLL_AND_ARC),
    },
    ...
    /*67*/[FlaccoId.RIGHT_BARB]: {
        core: getHead(HeadId.RIGHT_BARB),
    },
    /*68*/[FlaccoId.WING_WITH_RIGHT_BARB]: {
        arm: getArm(ArmId.WING),
        core: getHead(HeadId.RIGHT_BARB),
    },
    ...
    /*71*/[FlaccoId.WING_WITH_LEFT_ARC]: {
        arm: getArm(ArmId.WING),
        core: getHead(HeadId.LEFT_ARC),
    },
    /*72*/[FlaccoId.BIRD_WITH_LEFT_ARC]: {
        arm: getArm(ArmId.BIRD),
        core: getHead(HeadId.LEFT_ARC),
    },
    /*73*/[FlaccoId.WING_FROM_TICK_WITH_LEFT_ARC]: {
        arm: getArm(ArmId.WING_FROM_TICK),
        core: getHead(HeadId.LEFT_ARC),
    },
    /*74*/[FlaccoId.TICK_WITH_LEFT_ARC]: {
        arm: getArm(ArmId.TICK),
        core: getHead(HeadId.LEFT_ARC),
    },
    ...
    /*77*/[FlaccoId.WING_WITH_BOATHOOK_AND_ARC]: {
        arm: getArm(ArmId.WING),
        core: getHead(HeadId.BOATHOOK_AND_ARC),
    },
    /*78*/[FlaccoId.WING_AND_TICK_AGAINST_ARC_AND_SCROLL]: {
        arm: getArm(ArmId.WING_AND_TICK, Orientation.AGAINST),
        core: getHead(HeadId.ARC_AND_SCROLL),
    },
    /*79*/[FlaccoId.TICK_AGAINST_ARC_AND_SCROLL]: {
        arm: getArm(ArmId.TICK, Orientation.AGAINST),
        core: getHead(HeadId.ARC_AND_SCROLL),
    },
    /*80*/[FlaccoId.TICK_WITH_BOATHOOK_AND_ARC]: {
        arm: getArm(ArmId.TICK),
        core: getHead(HeadId.BOATHOOK_AND_ARC),
    },
    /*81*/[FlaccoId.BARB_AND_BOATHOOK]: {
        core: getHead(HeadId.BARB_AND_BOATHOOK),
    },
    ...
    /*85*/[FlaccoId.WING_WITH_ARC_AND_SCROLL]: {
        arm: getArm(ArmId.WING),
        core: getHead(HeadId.ARC_AND_SCROLL),
    },
    /*86*/[FlaccoId.BOATHOOK_AND_BARB]: {
        core: getHead(HeadId.BOATHOOK_AND_BARB),
    },
    /*87*/[FlaccoId.WING_AND_TICK_AGAINST_DOUBLE_LEFT_BARB]: {
        arm: getArm(ArmId.WING_AND_TICK, Orientation.AGAINST),
        core: getHead(HeadId.DOUBLE_LEFT_BARB),
    },
    /*88*/[FlaccoId.TICK_AGAINST_DOUBLE_LEFT_BARB]: {
        arm: getArm(ArmId.TICK, Orientation.AGAINST),
        core: getHead(HeadId.DOUBLE_LEFT_BARB),
    },
    /*89*/[FlaccoId.WING_FROM_TICK_AGAINST_DOUBLE_LEFT_BARB]: {
        arm: getArm(ArmId.WING_FROM_TICK, Orientation.AGAINST),
        core: getHead(HeadId.DOUBLE_LEFT_BARB),
    },
    ...
    /*93*/[FlaccoId.WING_WITH_DOUBLE_LEFT_BARB]: {
        arm: getArm(ArmId.WING),
        core: getHead(HeadId.DOUBLE_LEFT_BARB),
    },
    /*94*/[FlaccoId.BIRD_WITH_DOUBLE_LEFT_BARB]: {
        arm: getArm(ArmId.BIRD),
        core: getHead(HeadId.DOUBLE_LEFT_BARB),
    },
    /*95*/[FlaccoId.WING_FROM_TICK_WITH_DOUBLE_LEFT_BARB]: {
        arm: getArm(ArmId.WING_FROM_TICK),
        core: getHead(HeadId.DOUBLE_LEFT_BARB),
    },
    /*96*/[FlaccoId.TICK_WITH_DOUBLE_LEFT_BARB]: {
        arm: getArm(ArmId.TICK),
        core: getHead(HeadId.DOUBLE_LEFT_BARB),
    },
    ...
    /*100*/[FlaccoId.WING_WITH_LEFT_SCROLL_DOUBLE_LEFT_BARB]: {
        arm: getArm(ArmId.WING),
        core: getHead(HeadId.LEFT_SCROLL_DOUBLE_LEFT_BARB),
    },
    /*101*/[FlaccoId.BIRD_WITH_LEFT_SCROLL_DOUBLE_LEFT_BARB]: {
        arm: getArm(ArmId.BIRD),
        core: getHead(HeadId.LEFT_SCROLL_DOUBLE_LEFT_BARB),
    },
    /*102*/[FlaccoId.BIRD_AGAINST_BARB_AND_ARC]: {
        arm: getArm(ArmId.BIRD, Orientation.AGAINST),
        core: getHead(HeadId.BARB_AND_ARC),
    },
    ...
    /*105*/[FlaccoId.WING_WITH_BARB_AND_ARC]: {
        arm: getArm(ArmId.WING),
        core: getHead(HeadId.BARB_AND_ARC),
    },
    /*106*/[FlaccoId.ARC_AND_BOATHOOK]: {
        core: getHead(HeadId.ARC_AND_BOATHOOK),
    },
    /*107*/[FlaccoId.WING_FROM_TICK_WITH_BARB_AND_ARC]: {
        arm: getArm(ArmId.WING_FROM_TICK),
        core: getHead(HeadId.BARB_AND_ARC),
    },
    /*108*/[FlaccoId.TICK_WITH_BARB_AND_ARC]: {
        arm: getArm(ArmId.TICK),
        core: getHead(HeadId.BARB_AND_ARC),
    },
    /*109*/[FlaccoId.WING_AND_TICK_WITH_BARB_AND_ARC]: {
        arm: getArm(ArmId.WING_AND_TICK),
        core: getHead(HeadId.BARB_AND_ARC),
    },
    /*110*/[FlaccoId.TICK_AGAINST_DOUBLE_BARB]: {
        arm: getArm(ArmId.TICK, Orientation.AGAINST),
        core: getHead(HeadId.DOUBLE_BARB),
    },
    /*111*/[FlaccoId.WING_FROM_TICK_AGAINST_DOUBLE_BARB]: {
        arm: getArm(ArmId.WING_FROM_TICK, Orientation.AGAINST),
        core: getHead(HeadId.DOUBLE_BARB),
    },
    ...
    /*115*/[FlaccoId.WING_WITH_DOUBLE_BARB]: {
        arm: getArm(ArmId.WING),
        core: getHead(HeadId.DOUBLE_BARB),
    },
    /*116*/[FlaccoId.WING_AGAINST_LEFT_ARC_AND_BARB]: {
        arm: getArm(ArmId.WING, Orientation.AGAINST),
        core: getHead(HeadId.LEFT_ARC_AND_BARB),
    },
    /*117*/[FlaccoId.LEFT_ARC_AND_BARB]: {
        core: getHead(HeadId.LEFT_ARC_AND_BARB),
    },
    /*118*/[FlaccoId.WING_WITH_LEFT_ARC_AND_BARB]: {
        arm: getArm(ArmId.WING),
        core: getHead(HeadId.LEFT_ARC_AND_BARB),
    },
    /*119*/[FlaccoId.TICK_WITH_DOUBLE_BARB]: {
        arm: getArm(ArmId.TICK),
        core: getHead(HeadId.DOUBLE_BARB),
    },
    /*120*/[FlaccoId.WING_AND_TICK_WITH_DOUBLE_BARB]: {
        arm: getArm(ArmId.WING_AND_TICK),
        core: getHead(HeadId.DOUBLE_BARB),
    },
    /*121*/[FlaccoId.WING_AGAINST_LEFT_SCROLL_AND_DOUBLE_BARB]: {
        arm: getArm(ArmId.WING, Orientation.AGAINST),
        core: getHead(HeadId.LEFT_SCROLL_AND_DOUBLE_BARB),
    },
    /*122*/[FlaccoId.LEFT_SCROLL_AND_DOUBLE_BARB]: {
        core: getHead(HeadId.LEFT_SCROLL_AND_DOUBLE_BARB),
    },
    /*123*/[FlaccoId.WING_WITH_LEFT_SCROLL_AND_DOUBLE_BARB]: {
        arm: getArm(ArmId.WING),
        core: getHead(HeadId.LEFT_SCROLL_AND_DOUBLE_BARB),
    },
    /*124*/[FlaccoId.BIRD_WITH_LEFT_SCROLL_AND_DOUBLE_BARB]: {
        arm: getArm(ArmId.BIRD),
        core: getHead(HeadId.LEFT_SCROLL_AND_DOUBLE_BARB),
    },
    /*125*/[FlaccoId.WING_AND_TICK_AGAINST_DOUBLE_ARC]: {
        arm: getArm(ArmId.WING_AND_TICK, Orientation.AGAINST),
        core: getHead(HeadId.DOUBLE_ARC),
    },
    ...
    /*129*/[FlaccoId.WING_WITH_RIGHT_BARB_AND_ARC]: {
        arm: getArm(ArmId.WING),
        core: getHead(HeadId.RIGHT_BARB_AND_ARC),
    },
    ...
    /*132*/[FlaccoId.WING_WITH_DOUBLE_ARC]: {
        arm: getArm(ArmId.WING),
        core: getHead(HeadId.DOUBLE_ARC),
    },
    /*133*/[FlaccoId.BIRD_WITH_DOUBLE_ARC]: {
        arm: getArm(ArmId.BIRD),
        core: getHead(HeadId.DOUBLE_ARC),
    },
    /*134*/[FlaccoId.WING_FROM_TICK_WITH_DOUBLE_ARC]: {
        arm: getArm(ArmId.WING_FROM_TICK),
        core: getHead(HeadId.DOUBLE_ARC),
    },
    /*135*/[FlaccoId.TICK_WITH_DOUBLE_ARC]: {
        arm: getArm(ArmId.TICK),
        core: getHead(HeadId.DOUBLE_ARC),
    },
    /*136*/[FlaccoId.WING_AND_TICK_AGAINST_ARC_AND_BARB]: {
        arm: getArm(ArmId.WING_AND_TICK, Orientation.AGAINST),
        core: getHead(HeadId.ARC_AND_BARB),
    },
    /*137*/[FlaccoId.TICK_AGAINST_ARC_AND_BARB]: {
        arm: getArm(ArmId.TICK, Orientation.AGAINST),
        core: getHead(HeadId.ARC_AND_BARB),
    },
    /*138*/[FlaccoId.WING_FROM_TICK_AGAINST_ARC_AND_BARB]: {
        arm: getArm(ArmId.WING_FROM_TICK, Orientation.AGAINST),
        core: getHead(HeadId.ARC_AND_BARB),
    },
    /*139*/[FlaccoId.DOUBLE_RIGHT_BARB]: {
        core: getHead(HeadId.DOUBLE_RIGHT_BARB),
    },
    ...
    /*142*/[FlaccoId.WING_WITH_ARC_AND_BARB]: {
        arm: getArm(ArmId.WING),
        core: getHead(HeadId.ARC_AND_BARB),
    },
    /*143*/[FlaccoId.BIRD_WITH_ARC_AND_BARB]: {
        arm: getArm(ArmId.BIRD),
        core: getHead(HeadId.ARC_AND_BARB),
    },
    /*144*/[FlaccoId.BIRD_AGAINST_LEFT_SCROLL_DOUBLE_RIGHT_BARB]: {
        arm: getArm(ArmId.BIRD, Orientation.AGAINST),
        core: getHead(HeadId.LEFT_SCROLL_DOUBLE_RIGHT_BARB),
    },
    ...
    /*147*/[FlaccoId.WING_WITH_LEFT_SCROLL_DOUBLE_RIGHT_BARB]: {
        arm: getArm(ArmId.WING),
        core: getHead(HeadId.LEFT_SCROLL_DOUBLE_RIGHT_BARB),
    },
    /*148*/[FlaccoId.BIRD_WITH_LEFT_SCROLL_DOUBLE_RIGHT_BARB]: {
        arm: getArm(ArmId.BIRD),
        core: getHead(HeadId.LEFT_SCROLL_DOUBLE_RIGHT_BARB),
    },
}
