...
const {
    ...
    WING_AND_DOUBLE_ARC,
    BIRD_AND_DOUBLE_ARC,
    WING_AGAINST_TICK_AND_DOUBLE_ARC,
    TICK_AND_DOUBLE_ARC,
    WING_AND_TICK_AGAINST_ARC_AND_BARB,
    TICK_AGAINST_ARC_AND_BARB,
    WING_AGAINST_TICK_AGAINST_ARC_AND_BARB,
    DOUBLE_RIGHT_BARB,
