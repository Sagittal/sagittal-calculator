...
describe("formatTableForForum", (): void => {
    ...
    it("supports justification", (): void => {
        ...
        let expected =
            ...
            "[tr][td][pre][right]name[/right][/pre][/td][td][pre][center]limit[/center][/pre][/td][td][pre]SoPFR[/pre][/td][td][pre]cents[/pre][/td][td][pre]monzo[/pre][/td][td][pre]quotient[/pre][/td][td][pre]slope[/pre][/td][td][pre]N2D3P9[/pre][/td][/tr]" + NEWLINE +
