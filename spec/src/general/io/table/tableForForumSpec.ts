...
describe("formatTableForForum", (): void => {
    it("formats a table to be posted on the Sagittal forum", (): void => {
        ...
        let expected =
            "[table]\n" +
            "[tr][th][pre]comma name[/pre][/th][th][pre]prime limit[/pre][/th][th][pre]2,3-free SoPFR[/pre][/th][th][pre]cents[/pre][/th][th][pre]monzo[/pre][/th][th][pre]ratio[/pre][/th][th][pre]apotome slope[/pre][/th][th][pre]N2D3P9[/pre][/th][/tr]\n" +
    ...
    it("supports a custom count of header rows", (): void => {
        ...
        let expected =
            "[table]\n" +
            "[tr][th][pre]comma[/pre][/th][th][pre]prime[/pre][/th][th][pre]2,3-free[/pre][/th][th][pre][/pre][/th][th][pre][/pre][/th][th][pre][/pre][/th][th][pre]apotome[/pre][/th][th][pre][/pre][/th][/tr]\n" +
    ...
    it("supports colors per row", (): void => {
        ...
        let expected =
            "[table]\n" +
            "[tr][th][pre][hilite=yellow]comma[/hilite][/pre][/th][th][pre][hilite=yellow]prime[/hilite][/pre][/th][th][pre][hilite=yellow]2,3-free[/hilite][/pre][/th][th][pre][hilite=yellow][/hilite][/pre][/th][th][pre][hilite=yellow][/hilite][/pre][/th][th][pre][hilite=yellow][/hilite][/pre][/th][th][pre][hilite=yellow]apotome[/hilite][/pre][/th][th][pre][hilite=yellow][/hilite][/pre][/th][/tr]\n" +
    ...
    it("supports justification", (): void => {
        ...
        let expected =
            "[table]\n" +
            "[tr][th][pre][right]comma[/right][/pre][/th][th][pre][center]prime[/center][/pre][/th][th][pre]2,3-free[/pre][/th][th][pre][/pre][/th][th][pre][/pre][/th][th][pre][/pre][/th][th][pre]apotome[/pre][/th][th][pre][/pre][/th][/tr]\n" +
