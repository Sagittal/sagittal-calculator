...
describe("formatTableForForum", (): void => {
    it("formats a table to be posted on the Sagittal forum", (): void => {
        const table = [
            ["comma name", "prime limit", "2,3-free SoPFR", "cents", "monzo", "ratio", "apotome slope", "N2D3P9"],
        ...
        let expected =
            "[table]" + NEWLINE +
            "[tr][th][pre]comma name[/pre][/th][th][pre]prime limit[/pre][/th][th][pre]2,3-free SoPFR[/pre][/th][th][pre]cents[/pre][/th][th][pre]monzo[/pre][/th][th][pre]ratio[/pre][/th][th][pre]apotome slope[/pre][/th][th][pre]N2D3P9[/pre][/th][/tr]" + NEWLINE +
    ...
    it("supports a custom count of header rows", (): void => {
        ...
        let expected =
            ...
            "[tr][th][pre]name[/pre][/th][th][pre]limit[/pre][/th][th][pre]SoPFR[/pre][/th][th][pre]cents[/pre][/th][th][pre]monzo[/pre][/th][th][pre]ratio[/pre][/th][th][pre]slope[/pre][/th][th][pre]N2D3P9[/pre][/th][/tr]" + NEWLINE +     // Note the second header row!
            "[tr][td][pre]11M[/pre][/td][td][pre]11[/pre][/td][td][pre]11[/pre][/td][td][pre]45.45[/pre][/td][td][pre][0 0 1⟩[/pre][/td][td][pre]33/32[/pre][/td][td][pre]-4[/pre][/td][td][pre]6.722[/pre][/td][/tr]" + NEWLINE +
            "[tr][td][pre]25/49M[/pre][/td][td][pre]7[/pre][/td][td][pre]24[/pre][/td][td][pre]33.4[/pre][/td][td][pre][0 0⟩[/pre][/td][td][pre]50/49[/pre][/td][td][pre]-59.333[/pre][/td][td][pre]26.466[/pre][/td][/tr]" + NEWLINE +
            "[/table]" + NEWLINE as Io
        expect(actual).toEqual(expected)
    ...
    it("supports colors per row", (): void => {
        ...
        let expected =
            ...
            "[tr][td][pre][hilite=red]name[/hilite][/pre][/td][td][pre][hilite=red]limit[/hilite][/pre][/td][td][pre][hilite=red]SoPFR[/hilite][/pre][/td][td][pre][hilite=red]cents[/hilite][/pre][/td][td][pre][hilite=red]monzo[/hilite][/pre][/td][td][pre][hilite=red]ratio[/hilite][/pre][/td][td][pre][hilite=red]slope[/hilite][/pre][/td][td][pre][hilite=red]N2D3P9[/hilite][/pre][/td][/tr]" + NEWLINE +
    ...
    it("supports justification", (): void => {
        ...
        let expected =
            "[table]" + NEWLINE +
            "[tr][th][pre][right]comma[/right][/pre][/th][th][pre][center]prime[/center][/pre][/th][th][pre]2,3-free[/pre][/th][th][pre][/pre][/th][th][pre][/pre][/th][th][pre][/pre][/th][th][pre]apotome[/pre][/th][th][pre][/pre][/th][/tr]" + NEWLINE +
            "[tr][td][pre][right]name[/right][/pre][/td][td][pre][center]limit[/center][/pre][/td][td][pre]SoPFR[/pre][/td][td][pre]cents[/pre][/td][td][pre]monzo[/pre][/td][td][pre]ratio[/pre][/td][td][pre]slope[/pre][/td][td][pre]N2D3P9[/pre][/td][/tr]" + NEWLINE +
            "[tr][td][pre][right]11M[/right][/pre][/td][td][pre][center]11[/center][/pre][/td][td][pre]11[/pre][/td][td][pre]45.45[/pre][/td][td][pre][0 0 1⟩[/pre][/td][td][pre]33/32[/pre][/td][td][pre]-4[/pre][/td][td][pre]6.722[/pre][/td][/tr]" + NEWLINE +
            "[tr][td][pre][right]25/49M[/right][/pre][/td][td][pre][center]7[/center][/pre][/td][td][pre]24[/pre][/td][td][pre]33.4[/pre][/td][td][pre][0 0⟩[/pre][/td][td][pre]50/49[/pre][/td][td][pre]-59.333[/pre][/td][td][pre]26.466[/pre][/td][/tr]" + NEWLINE +
            "[/table]" + NEWLINE as Io
        expect(actual).toEqual(expected)
    })
