...
import { computeMaxNumeratorPrimeExponentGivenMaxN2D3P3 } from "../../../../../../src/general/music/n2d3p9/primeExponentExtremas/maxNumeratorPrimeExponent"
...
describe("computeMaxNumeratorPrimeExponentGivenMaxN2D3P3", () => {
    it("returns the max exponent for a given numerator prime (in isolation) given a max N2D3P9", () => {
        ...
        const expected = 6 as Max<Exponent<Prime>>
    ...
    it("another example, for prime 5", () => {
        ...
        const expected = 5 as Max<Exponent<Prime>>
        expect(actual).toBe(expected)
    })
    ...
    it("edge case: max N2D3P9 set to 0", () => {
        ...
        const expected = 0 as Max<Exponent<Prime>>
        expect(actual).toBe(expected)
    })
})
