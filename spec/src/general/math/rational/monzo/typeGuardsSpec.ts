...
import { isRationalMonzo } from "../../../../../../src/general/math/rational/monzo"
import { isIntegerMonzo } from "../../../../../../src/general/math/rational/monzo/typeGuards"
...
describe("isRationalMonzo", (): void => {
    it("returns true if every prime exponent is an integer", (): void => {
        ...
        const actual = isRationalMonzo(candidateRationalMonzo)
