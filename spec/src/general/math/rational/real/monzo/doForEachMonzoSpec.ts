...
describe("doForEachMonzo", (): void => {
    ...
    it("calls the work function once for each possible monzo given the prime exponent extremas", (): void => {
        ...
        doForEachMonzo(primeExponentExtremas, workFunction, arg1, arg2)
    ...
    it("returns an array of results from the work function", (): void => {
        const workFunction = (monzo: RationalMonzo): Maybe<string> => monzo[ 0 ] === -1 ? stringify(monzo) : undefined

        const actual = doForEachMonzo(primeExponentExtremas, workFunction)
