const {calculateBoundedCommaSymbols} = require("../../../../src/boundsAnalysis/data/calculateBoundedCommaSymbols")

describe("calculateBoundedCommaSymbols", () => {
    // it("gives the positions of the commas immediately lesser and greater than the position at that level", () => {
    //     expect(calculateBoundedCommaSymbols(9, "MEDIUM")).toEqual([
    //         5.7578022033852, // |(
    //         9.6879606428187, // )|(
    //     ])
    // })
    ...
    //     expect(calculateBoundedCommaSymbols(68.4, "VERY_HIGH")).toEqual([
    //         67.2910616147857, // )|\\
    //         undefined,
    //     ])
    // })
    ...
    it("gives the symbols of the commas immediately lesser and greater than the position at that level", () => {
        expect(calculateBoundedCommaSymbols(45, "VERY_HIGH")).toEqual([
            "'//|",
            ")//|",
        ])
    })
