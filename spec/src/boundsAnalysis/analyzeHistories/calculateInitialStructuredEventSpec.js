const {calculateInitialStructuredEvent} = require("../../../../src/boundsAnalysis/analyzeHistories/calculateInitialStructuredEvent")

describe("calculateInitialStructuredEvent", () => {
    let result
    const analyzedEvent = {
        type: "EDA",
        name: "12.5/58",
    ...
    beforeEach(() => {
        result = calculateInitialStructuredEvent(analyzedEvent)
    })
