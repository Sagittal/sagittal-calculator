const {computeImpossibleEvent} = require("../../../../src/boundsAnalysis/plot/impossibleEvent")

describe("computeImpossibleEvent", () => {
    it("returns an event stating that the history became impossible for this position at this level", () => {
        const result = computeImpossibleEvent(57.4999779541197, "VERY_HIGH", [58.0356258736789, 59.57953862346640])
    ...
    it("formats correctly when the upper bound undefined (representing the maximum position)", () => {
        const result = computeImpossibleEvent(57.4999779541197, "VERY_HIGH", [58.0356258736789, undefined])
    ...
    it("formats correctly when the lower bound undefined (representing the minimum position)", () => {
        const result = computeImpossibleEvent(1.4242979405308, "VERY_HIGH", [0, 0.83252420410159])
