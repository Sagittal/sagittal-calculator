const {formatRankSummaries} = require("../../../../src/boundsAnalysis/format/formatRankSummaries")
const {rankCounts, rankBoundIndices} = require("../../../../src/boundsAnalysis/analyzeHistories/rankSummary")
...
describe("formatRankSummaries", () => {
    it("gives the correct answer", () => {
        // reset and then calculate and analyze all the bounds as you would when running the main script in summary mode
