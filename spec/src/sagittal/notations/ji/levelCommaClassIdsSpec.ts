...
describe("JI_NOTATION_LEVELS_COMMA_CLASS_IDS", (): void => {
    it("has the correct count of comma classes per JI notation level", (): void => {
        expect(JI_NOTATION_LEVELS_COMMA_CLASS_IDS[ JiNotationLevel.MEDIUM ].length).toBe(13)
        expect(JI_NOTATION_LEVELS_COMMA_CLASS_IDS[ JiNotationLevel.HIGH ].length).toBe(32)
        expect(JI_NOTATION_LEVELS_COMMA_CLASS_IDS[ JiNotationLevel.ULTRA ].length).toBe(55)
        expect(JI_NOTATION_LEVELS_COMMA_CLASS_IDS[ JiNotationLevel.EXTREME ].length).toBe(149)
    })
