...
describe("addMaybeJiSymbol", (): void => {
    it(`adds the ASCII for a Sagittal JI symbol if there is one whose primary comma has this name`, (): void => {
        const comma: Comma = {
    ...
    it(`leaves the comma unchanged if there is no Sagittal JI symbol whose primary comma has this name`, (): void => {
        const comma: Comma = {
