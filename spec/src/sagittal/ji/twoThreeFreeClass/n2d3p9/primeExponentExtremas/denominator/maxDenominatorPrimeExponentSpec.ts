import { Exponent, Max, Min, Prime, RationalNumerator } from "../../../../../../../../src/general"
...
describe("computeMaxDenominatorPrimeExponentGivenMaxN2D3P9", (): void => {
    it("returns the max exponent for a denominator prime given a max N2D3P9", (): void => {
        const denominatorPrime = 5 as RationalDenominator & Prime
        ...
        const numeratorPossibilitiesForDenominatorGivenMaxN2D3P9 = [
            ...
            { numerator: 29 as RationalNumerator, gpf: 29 as Max<Prime> },
            { numerator: 31 as RationalNumerator, gpf: 31 as Max<Prime> },
            { numerator: 35 as RationalNumerator, gpf: 7 as Max<Prime> },
            { numerator: 37 as RationalNumerator, gpf: 37 as Max<Prime> },
            { numerator: 41 as RationalNumerator, gpf: 41 as Max<Prime> },
            { numerator: 43 as RationalNumerator, gpf: 43 as Max<Prime> },
            { numerator: 47 as RationalNumerator, gpf: 47 as Max<Prime> },
            { numerator: 49 as RationalNumerator, gpf: 7 as Max<Prime> },
            // It actually goes on...
        ...
        const expected = 2 as Max<RationalDenominator & Exponent<Prime>>
    ...
    it("gets the sorted numerator possibilities, then works its way up through each candidate max exponent for the denominator prime, seeing what the min N2D3P9 is for it, and returning the max exponent whose min N2D3P9 is less than the max N2D3P9", (): void => {
        const denominatorPrime = 1033 as RationalDenominator & Prime // Something crazy
        ...
        expect(minN2D3P9.computeMinN2D3P9ForCandidateMaxDenominatorPrimeExponentGivenMaxN2D3P9).toHaveBeenCalledWith({
            ...
            denominatorPrime,
            candidateMaxDenominatorPrimeExponentGivenMaxN2D3P9: 1 as Max<RationalDenominator & Exponent<Prime>>,
        })
        expect(minN2D3P9.computeMinN2D3P9ForCandidateMaxDenominatorPrimeExponentGivenMaxN2D3P9).toHaveBeenCalledWith({
            sortedNumeratorPossibilitiesForDenominatorPrimeGivenMaxN2D3P9,
            denominatorPrime,
            candidateMaxDenominatorPrimeExponentGivenMaxN2D3P9: 2 as Max<RationalDenominator & Exponent<Prime>>,
        })
        const expected = 2 as Max<RationalDenominator & Exponent<Prime>>
        expect(actual).toBe(expected)
    })
