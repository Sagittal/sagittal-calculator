...
import { computeMaxNumeratorPrimeExponentsGivenMaxN2D3P9 } from "../../../../../../../../src/sagittal/n2d3p9/primeExponentExtremas/denominator/sortedNumeratorPossibilities/numeratorPossibilities/maxNumeratorPrimeExponents"
...
describe("computeMaxNumeratorPrimeExponentsGivenMaxN2D3P9", () => {
    ...
    it("edge case - max N2D3P9 of 1 given", () => {
