...
describe("popular-2-3-free-classes", (): void => {
    it("gives you the list of the most popular 3,3-free classes, according to N2D3P9", (): void => {
        ...
        const expected = [
            ...
            "[tr][th][pre][/pre][/th][th][pre][/pre][/th][th][pre]notating[/pre][/th][th][pre]smallest[/pre][/th][th][pre][/pre][/th][th][pre][/pre][/th][th][pre][/pre][/th][/tr]",
            ...
            "[tr][td][pre]1/1[/pre][/td][td][pre]  1.000[/pre][/td][td][pre](:h:) :'::/|:[/pre][/td][td][pre]0, 5[/pre][/td][td][pre]1[/pre][/td][td][pre]1[/pre][/td][td][pre]7624[/pre][/td][/tr]",
    ...
    it("can associate the popular 2,3-free classes with their best notating commas (instead of all of their exactly notating symbol classes)", (): void => {
        ...
        const expected = [
            ...
            "[tr][td][pre]1/1[/pre][/td][td][pre]1[/pre][/td][td][pre]         0.000¢[/pre][/td][td][pre][  ⟩[/pre][/td][td][pre](:h:)[/pre][/td][/tr]",
