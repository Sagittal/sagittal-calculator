...
describe("late-tina-commas", (): void => {
    it("finds LATE commas for tinas", (): void => {
        ...
        const expected = [
            ...
            `TINA 6: {"pitch":{"monzo":[5,-3,1,-1,-1,1]},"monzo":[5,-3,1,-1,-1,1],"quotient":[2080,2079],"cents":0.8325242041015989,"decimal":1.0004810004810005,"two3FreeClassAnalysis":{"two3FreeClass":{"monzo":[0,0,-1,1,1,-1]},"name":"{77/65}₂,₃","two3FreePrimeLimit":13,"two3FreeSopfr":36,"two3FreeCopfr":4,"n2d3p9":200.8179012345679},"apotomeSlope":-3.0512615482973438,"aas":3.0512615482973438,"ate":3,"sizeCategory":"schismina","name":"65/77n"}`,
            `NO COMMAS given current constraints for tina 6.5.`,
            `TINA 7: {"pitch":{"monzo":[-2,5,-2,1,0,0,-1]},"monzo":[-2,5,-2,1,0,0,-1],"quotient":[1701,1700],"cents":1.0180735659853197,"decimal":1.0005882352941178,"two3FreeClassAnalysis":{"two3FreeClass":{"monzo":[0,0,2,-1,0,0,1]},"name":"{425/7}₂,₃","two3FreePrimeLimit":17,"two3FreeSopfr":34,"two3FreeCopfr":4,"n2d3p9":234.14351851851853},"apotomeSlope":4.9373135014983465,"aas":4.9373135014983465,"ate":5,"sizeCategory":"schismina","name":"7/(5²⋅17)n"}`,
