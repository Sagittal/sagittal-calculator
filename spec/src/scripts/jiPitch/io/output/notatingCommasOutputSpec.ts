...
describe("computeNotatingCommasOutput", (): void => {
    ...
    it("can format the symbols for the forum", (): void => {
        ...
        const expected =
            ...
            "[tr][td][pre][/pre]:/|\\:[pre][/pre][/td][td][pre]11M   [/pre][/td][td][pre][/pre][latex]\\frac{33}{32}[/latex][pre][/pre][/td][td][pre][   0   0   1 ⟩    [/pre][/td][td][pre]        45.450¢[/pre][/td][td][pre] -4.000[/pre][/td][td][pre]  4.000[/pre][/td][td][pre]  0    [/pre][/td][/tr]" + NEWLINE +
            "[tr][td][pre]      [/pre][/td][td][pre]25/49M[/pre][/td][td][pre][/pre][latex]\\frac{50}{49}[/latex][pre][/pre][/td][td][pre][   1   0   2  -2 ⟩[/pre][/td][td][pre]        33.400¢[/pre][/td][td][pre] -2.154[/pre][/td][td][pre]  2.154[/pre][/td][td][pre]  0    [/pre][/td][/tr]" + NEWLINE +
            "[/table]" + NEWLINE as Io
        expect(actual).toBe(expected)
    })
})
