...
describe("computeFindCommasOutput", (): void => {
    ...
    it("changes column widths so that each cell in a column has the same width", (): void => {
        ...
        const expected =
            ...
            "" + NEWLINE +
            "        \t      \t     \t                   \t       \t       \t2,3-free\t2,3-free\t2,3-free\t2,3-free" + NEWLINE +
    ...
    it("can format tables for sharing on the Sagittal forum", (): void => {
        ...
        const expected =
            ...
            "" + NEWLINE +
            "[table]" + NEWLINE +
            "[tr][th][pre][/pre][/th][th][pre][/pre][/th][th][pre][/pre][/th][th][pre][/pre][/th][th][pre][/pre][/th][th][pre][/pre][/th][th][pre]2,3-free[/pre][/th][th][pre]2,3-free[/pre][/th][th][pre]2,3-free[/pre][/th][th][pre]2,3-free[/pre][/th][/tr]" + NEWLINE +
