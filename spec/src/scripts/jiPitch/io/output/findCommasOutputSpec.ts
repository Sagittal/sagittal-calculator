...
describe("computeFindCommasOutput", (): void => {
    ...
    it("can format tables for sharing on the Sagittal forum", (): void => {
        ...
        const expected =
            ...
            "" + NEWLINE +
            "[table]" + NEWLINE +
            "[tr][th][/th][th][/th][th][/th][th][/th][th][/th][th][/th][th][/th][th][/th][th][/th][th][/th][th][/th][th][/th][th][/th][th]2,3-free[/th][th]2,3-free[/th][th]2,3-free[/th][th]2,3-free[/th][th]2,3-free[/th][/tr]" + NEWLINE +
            "[tr][th]comma[/th][th][/th][th][/th][th]monzo[/th][th][/th][th][/th][th][/th][th][/th][th][/th][th][/th][th]apotome[/th][th][/th][th][/th][th]prime[/th][th]class[/th][th]class[/th][th]class[/th][th]class[/th][/tr]" + NEWLINE +
            "[tr][th]class[/th][th]name[/th][th]quotient[/th][th] [/th][th]  2    [/th][th]  3    [/th][th]  5    [/th][th]  7    [/th][th] [/th][th]cents[/th][th]slope[/th][th]AAS[/th][th]ATE[/th][th]limit[/th][th]name[/th][th]CoPFR[/th][th]SoPFR[/th][th]N2D3P9[/th][/tr]" + NEWLINE +
            "[tr][td]:/|\\:[/td][td]11M[/td][td][latex]\\frac{33}{32}[/latex][/td][tn][[/tn][tc]  0    [/tc][tc]  0    [/tc][tc]  1    [/tc][tc][/tc][td]⟩[/td][td] 45.450¢[/td][td] -4.000[/td][td]  4.000[/td][td]  0    [/td][td] 11    [/td][td][latex]\\{11\\}_{\\scriptsize{2,3}}[/latex][/td][td]  1    [/td][td] 11    [/td][td]  6.722[/td][/tr]" + NEWLINE +
            "[tr][td][/td][td]25/49M[/td][td][latex]\\frac{50}{49}[/latex][/td][tn][[/tn][tc]  1    [/tc][tc]  0    [/tc][tc]  2    [/tc][tc] -2    [/tc][td]⟩[/td][td] 33.400¢[/td][td] -2.154[/td][td]  2.154[/td][td]  0    [/td][td]  7    [/td][td][latex]\\{\\frac{49}{25}\\}_{\\scriptsize{2,3}}[/latex][/td][td]  4    [/td][td] 24    [/td][td] 26.466[/td][/tr]" + NEWLINE +
            "[/table]" + NEWLINE as Io
        expect(actual).toEqual(expected)
    })
    ...
    it("can format tables for sharing on the Sagittal forum, but where the splitting of quotients and 2,3-free classes is preferred", (): void => {
        ...
        const expected =
            ...
            "" + NEWLINE +
            "[table]" + NEWLINE +
            "[tr][th][/th][th][/th][th][/th][th][/th][th][/th][th][/th][th][/th][th][/th][th][/th][th][/th][th][/th][th][/th][th][/th][th][/th][th][/th][th]2,3-free[/th][th]2,3-free[/th][th][/th][th][/th][th][/th][th]2,3-free[/th][th]2,3-free[/th][th]2,3-free[/th][/tr]" + NEWLINE +
            "[tr][th]comma[/th][th][/th][th]quotient[/th][th][/th][th][/th][th]monzo[/th][th][/th][th][/th][th][/th][th][/th][th][/th][th][/th][th]apotome[/th][th][/th][th][/th][th]prime[/th][th]class[/th][th][/th][th][/th][th][/th][th]class[/th][th]class[/th][th]class[/th][/tr]" + NEWLINE +
            "[tr][th]class[/th][th]name[/th][th]n[/th][th]/[/th][th]d[/th][th] [/th][th]  2    [/th][th]  3    [/th][th]  5    [/th][th]  7    [/th][th] [/th][th]cents[/th][th]slope[/th][th]AAS[/th][th]ATE[/th][th]limit[/th][th]n[/th][th]/[/th][th]d[/th][th][latex]_{\\scriptsize{2,3}}[/latex][/th][th]CoPFR[/th][th]SoPFR[/th][th]N2D3P9[/th][/tr]" + NEWLINE +
            "[tr][td]:/|\\:[/td][td]11M[/td][tn]33[/tn][tc]/[/tc][td]32[/td][tn][[/tn][tc]  0    [/tc][tc]  0    [/tc][tc]  1    [/tc][tc][/tc][td]⟩[/td][td] 45.450¢[/td][td] -4.000[/td][td]  4.000[/td][td]  0    [/td][td] 11    [/td][tn]11[/tn][tc]/[/tc][td]1[/td][td][latex]_{\\scriptsize{2,3}}[/latex][/td][td]  1    [/td][td] 11    [/td][td]  6.722[/td][/tr]" + NEWLINE +
            "[tr][td][/td][td]25/49M[/td][tn]50[/tn][tc]/[/tc][td]49[/td][tn][[/tn][tc]  1    [/tc][tc]  0    [/tc][tc]  2    [/tc][tc] -2    [/tc][td]⟩[/td][td] 33.400¢[/td][td] -2.154[/td][td]  2.154[/td][td]  0    [/td][td]  7    [/td][tn]49[/tn][tc]/[/tc][td]25[/td][td][latex]_{\\scriptsize{2,3}}[/latex][/td][td]  4    [/td][td] 24    [/td][td] 26.466[/td][/tr]" + NEWLINE +
            "[/table]" + NEWLINE as Io
        expect(actual).toEqual(expected)
    })
