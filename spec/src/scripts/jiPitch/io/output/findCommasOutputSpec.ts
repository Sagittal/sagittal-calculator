...
describe("computeFindCommasOutput", (): void => {
    ...
    it("can format tables for sharing on the Sagittal forum", (): void => {
        ...
        const expected =
            ...
            "[tr][th]comma[/th][th][/th][th][/th][thr]monzo[/thr][th][/th][th][/th][th][/th][th][/th][thl][/thl][th][/th][th]apotome[/th][th][/th][th][/th][th]prime[/th][th]class[/th][th]class[/th][th]class[/th][th]class[/th][/tr]" + NEWLINE +
    ...
    it("can format tables for sharing on the Sagittal forum, but where the splitting of quotients and 2,3-free classes is preferred", (): void => {
        ...
        const expected =
            ...
            "" + NEWLINE +
            "[table]" + NEWLINE +
            "[tr][th][/th][th][/th][thr][/thr][th][/th][thl][/thl][thr][/thr][th][/th][th][/th][th][/th][th][/th][thl][/thl][th][/th][th][/th][th][/th][th][/th][th]2,3-free[/th][thr]2,3-free[/thr][th][/th][thl][/thl][th][/th][th]2,3-free[/th][th]2,3-free[/th][th]2,3-free[/th][/tr]" + NEWLINE +
            "[tr][th]comma[/th][th][/th][thr]quotient[/thr][th][/th][thl][/thl][thr]monzo[/thr][th][/th][th][/th][th][/th][th][/th][thl][/thl][th][/th][th]apotome[/th][th][/th][th][/th][th]prime[/th][thr]class[/thr][th][/th][thl][/thl][th][/th][th]class[/th][th]class[/th][th]class[/th][/tr]" + NEWLINE +
