...
describe("computeCommas", () => {
    ...
    it("throws an error if the min or max cents are outside than the abs value of the max size category bound", () => {
        expect(() => computeCommas({
            max23FreeSopfr,
    ...
    it("returns commas if the min and max cents are within the abs value of the max size category bound", () => {
