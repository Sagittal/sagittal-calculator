...
describe("find-commas", (): void => {
    it("finds commas, given the finding options", (): void => {
        ...
        const expected = [
            ...
            "class \tname  \t       n\t/\td \t    [\t  2    \t  3    \t  5    \t  7    \t 11    \t 13    \t 17    \t 19    \t 23    \t 29    \t⟩\tcents          \tslope  \tAAS    \tATE    \tlimit   \tname      \tCoPFR   \tSoPFR   \tN2D3P9  ",
    ...
    it("can exclude fields from the results", (): void => {
        ...
        const expected = [
            ...
            "      \t      \t        \t \t  \t     \t       \t       \t       \t       \t       \t       \t       \t       \t       \t       \t \t               \t       \t2,3-free\t2,3-free  \t2,3-free\t2,3-free\t2,3-free",
            "symbol\t      \tquotient\t \t  \tmonzo\t       \t       \t       \t       \t       \t       \t       \t       \t       \t       \t \t               \tapotome\tprime   \tclass     \tclass   \tclass   \tclass   ",
            "class \tname  \t       n\t/\td \t    [\t  2    \t  3    \t  5    \t  7    \t 11    \t 13    \t 17    \t 19    \t 23    \t 29    \t⟩\tcents          \tslope  \tlimit   \tname      \tCoPFR   \tSoPFR   \tN2D3P9  ",
    ...
    it("can format for a spreadsheet", (): void => {
        ...
        const command = `           \
        npm run find-commas -- --lower-bound 50c --upper-bound 50.31c --sort-by apotomeSlope --table-format spreadsheet \
        ` as Io
