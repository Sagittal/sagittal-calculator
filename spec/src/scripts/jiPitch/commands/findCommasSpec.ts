...
describe("find-commas", (): void => {
    ...
    it("can sort the resulting list", (): void => {
        ...
        const expected = [
            ...
            "symbol  \tcomma  \t                 \t                                   \t       \tapotome\tprime   \tclass   \tclass   \tclass   \tclass   ",
            "class   \tname   \tratio            \tmonzo                              \tcents  \tslope  \tlimit   \tname    \tCoPFR   \tSoPFR   \tN2D3P9  ",
            "        \t19/175M\t4864/4725        \t[   8  -3  -2  -1   0   0   0   1 ⟩\t 50.195\t -6.091\t 19     \t175/19  \t  4     \t 36     \t292.477 ",
            "        \t35/17M \t35/34            \t[  -1   0   1   1   0   0  -1 ⟩    \t 50.184\t -3.090\t 17     \t35/17   \t  3     \t 29     \t 93.657 ",
            "  ,'/|) \t65M    \t34543665/33554432\t[ -25  12   1   0   0   1 ⟩        \t 50.301\t  8.903\t 13     \t65/1    \t  2     \t 18     \t 23.472 ",
            "        \t1/3025M\t1594323/1548800  \t[  -9  13  -2   0  -2 ⟩            \t 50.152\t  9.912\t 11     \t3025/1  \t  4     \t 32     \t231.076 ",
            "",
        ] as Io[]
        expect(actual).toEqual(expected)
    })
    ...
    it("can set the format of the comma names", (): void => {
        ...
        const expected = [
            ...
            "symbol  \tcomma                \t                 \t                                   \t       \tapotome\tprime   \tclass   \tclass   \tclass   \tclass   ",
            "class   \tname                 \tratio            \tmonzo                              \tcents  \tslope  \tlimit   \tname    \tCoPFR   \tSoPFR   \tN2D3P9  ",
            "  ,'/|) \t5.13-Medium-Diesis   \t34543665/33554432\t[ -25  12   1   0   0   1 ⟩        \t 50.301\t  8.903\t 13     \t65/1    \t  2     \t 18     \t 23.472 ",
            "        \t17:5.7-Medium-Diesis \t35/34            \t[  -1   0   1   1   0   0  -1 ⟩    \t 50.184\t -3.090\t 17     \t35/17   \t  3     \t 29     \t 93.657 ",
            "        \t5².11²-Medium-Diesis \t1594323/1548800  \t[  -9  13  -2   0  -2 ⟩            \t 50.152\t  9.912\t 11     \t3025/1  \t  4     \t 32     \t231.076 ",
            "        \t19:5².7-Medium-Diesis\t4864/4725        \t[   8  -3  -2  -1   0   0   0   1 ⟩\t 50.195\t -6.091\t 19     \t175/19  \t  4     \t 36     \t292.477 ",
            "",
        ] as Io[]
        expect(actual).toEqual(expected)
    })
