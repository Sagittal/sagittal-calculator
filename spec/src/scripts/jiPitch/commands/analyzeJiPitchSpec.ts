...
describe("analyze-ji-pitch", (): void => {
    ...
    it("can filter the notating commas", (): void => {
        ...
        // Note: because the abs apotome slope is filtered to 3,
    ...
    it("can appraise a JI pitch which is just a simple integer", (): void => {
        ...
        const expected = [
            ...
            "cents range:                \t  0.000 -  56.843",
            "max abs 3 exponent (ATE):   \t 15    ",
            "max abs apotome slope (AAS):\t600.000",
            "max N2D3P9:                 \t307.000",
            "",
            "   --- notating commas ---",
            "",
    ...
    it("automatically adjusts the filters to include the JI pitch itself in the list of notating commas", (): void => {
        ...
        const expected = [
            ...
            "",
            "Adjusting max abs 3 exponent for notating commas from  15     to  19     to accommodate the given pitch.",
            "Adjusting max N2D3P9 for notating commas from 307.000 to 477.991 to accommodate the given pitch.",
            "",
            "cents range:                \t  0.000 -  56.843",
            "max abs 3 exponent (ATE):   \t 19    ",
            "max abs apotome slope (AAS):\t 14.000",
            "max N2D3P9:                 \t477.991",
            "",
            "   --- notating commas ---",
