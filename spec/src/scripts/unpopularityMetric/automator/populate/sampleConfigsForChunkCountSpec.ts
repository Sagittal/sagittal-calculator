// import {populateSampleConfigsForChunkCount} from "../../../../../src/scripts/unpopularityMetric/automator/initialSampleConfigs"
...
//
// describe("populateSampleConfigsForChunkCount", () => {
//     it("given a chunk resolution, returns all possible combinations of those parameters - works for 1", () => {
//         const chunkCount = 1
//
//         const result = populateSampleConfigsForChunkCount(chunkCount, {quiet: true})
//
