import { getSumOfSquaresAtSamplePointIfLocalMinimum } from "../../../../../../src/scripts/unpopularityMetric/automator/process/localMinimum"
import { setSumOfSquaresAtSamplePoint } from "../../../../../../src/scripts/unpopularityMetric/automator/process/setSumOfSquaresAtSamplePoint"
...
describe("getSumOfSquaresAtSamplePointIfLocalMinimum", () => {
    ...
    beforeEach(() => {
        ...
        // setSumOfSquaresAtSamplePoint(0.00666 as SumOfSquares, sumsOfSquares, [1, 1, 1, 2]) this example is NOT QUITE a local minimum!
    })
