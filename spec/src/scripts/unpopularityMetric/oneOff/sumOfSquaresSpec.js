describe("one-off sum-of-squares", () => {
    it("gives you the sum-of-squares given the submetric combination in the file, and also logs the full list of unpopularities", () => {
        ...
        expect(result[result.length - 2]).toBe(`0.0047891431208488214`)
        expect(result[result.length - 1]).toBe(`[{"k":0,"a":1.994,"aIsBaseNotPower":1,"y":0.455,"w":-2.08},{"submetricType":"coapfar","weight":0.577}]`)
    })
})
