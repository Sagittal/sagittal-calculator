...
describe("computeInitialEventConsolidation", () => {
    ...
    it("initializes the rank related fields to the worst rank (so that there's nowhere to go but up when updating them with data from the history analyses", () => {
    ...
    it("strips off the rank that was created in the analyze step, replacing it with the rank measurements that are appropriate for the history consolidation", () => {
