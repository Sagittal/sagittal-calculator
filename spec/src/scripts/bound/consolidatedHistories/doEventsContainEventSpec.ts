...
import { computeDoEventsContainEvent } from "../../../../../src/scripts/bound/consolidatedHistories/doEventsContainEvent"
...
describe("computeDoEventsContainEvent", () => {
    ...
    it("returns false when the events contain an event which has the same name but not the same level", () => {
        ...
        const targetEvent = {
            ...analyzedEventFixture,
            name: "someName" as Name<Pitch>, level: "otherLevel" as Level, rank: 2 as Integer & Rank<AnalyzedEvent>,
        }
