...
describe("popular-ratios", () => {
    it("gives you the list of the most popular ratios, according to N2D3P9", () => {
        ...
        const expected = [
            ...
            "",
            "[table]",
            "[tr][th]2,3-equivalent[/th][th][/th][th]exactly[/th][th]introducing[/th][th][/th][th][/th][th][/th][/tr]",
            "[tr][th]pitch[/th][th][/th][th]notating[/th][th]symbol[/th][th][/th][th]Scala[/th][th]Scala[/th][/tr]",
            "[tr][th]ratio[/th][th][/th][th]JI[/th][th]subset[/th][th]N2D3P9[/th][th]archive[/th][th]archive[/th][/tr]",
