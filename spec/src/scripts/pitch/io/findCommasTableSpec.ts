...
describe("computeFindCommasTable", () => {
    ...
    it("aligns each comma output to the same width per column", () => {
        ...
        const expected =
            ...
            "    /|\\ \t11M   \t33/32\t[   0   0   1 ⟩    \t45.450\t-4.000       \t11   \t11           \t6.72  \n" +
            "        \t25/49M\t50/49\t[   1   0   2  -2 ⟩\t33.400\t-2.154       \t7    \t24           \t26.47 \n" as Io
    ...
    it("can format tables for sharing on the Sagittal forum", () => {
        ...
        const expected =
            "[table]\n" +
            "[tr][th]symbol[/th][th]name[/th][th]ratio[/th][th]monzo[/th][th]cents[/th][th]apotome slope[/th][th]limit[/th][th]5-rough sopfr[/th][th]N2D3P9[/th][/tr]\n" +
            "[tr][td]    /|\\ [/td][td]11M[/td][td]33/32[/td][td][   0   0   1 ⟩[/td][td]45.450[/td][td]-4.000[/td][td]11[/td][td]11[/td][td]6.72[/td][/tr]\n" +
            "[tr][td][/td][td]25/49M[/td][td]50/49[/td][td][   1   0   2  -2 ⟩[/td][td]33.400[/td][td]-2.154[/td][td]7[/td][td]24[/td][td]26.47[/td][/tr]\n" +
            "[/table]\n" as Io
        expect(actual).toEqual(expected)
    })
})
