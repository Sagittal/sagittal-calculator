...
describe("computeWeightedSopifgtt", () => {
    it("sums the absolute values of the prime factors greater than three in the monzo, mapped to the prime count function, and weighted by raising them to the provided power", () => {
        const monzo = [
            5,  // 1
            6,  // 2
            0,  // 3
