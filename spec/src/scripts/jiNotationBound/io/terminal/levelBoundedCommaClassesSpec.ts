...
import { computeJiNotationLevelBoundedCommaClassIdsWithDistances } from "../../../../../../src/scripts/jiNotationBound/io/terminal/levelBoundedCommaClasses"
import { JiNotationBoundIdWithBoundedCommaClassIdsWithDistancesPairsByJiNotationLevel } from "../../../../../../src/scripts/jiNotationBound/io/terminal/types"

describe("computeJiNotationLevelBoundedCommaClassIdsWithDistances", (): void => {
    it("returns, given a JI notation bound, for each of its JI levels, an array of the pair of comma class positions it bounds at that JI notation level, as well as their distances and ina-distances from the bound", (): void => {
        ...
        const actual = computeJiNotationLevelBoundedCommaClassIdsWithDistances(jiNotationBound)

        const expected: JiNotationBoundIdWithBoundedCommaClassIdsWithDistancesPairsByJiNotationLevel = {
            id: 51 as Id<JiNotationBound>,
