...
describe("isBoundEventContained", (): void => {
    it("returns true when the bound events contain an event which has the same name and the same JI notation level            ", (): void => {
    ...
    it("returns false when the bound events contain an event which has the same name but not the same JI notation level            ", (): void => {
    ...
    it("returns false when the bound events contain an event which has the same JI notation level but not the same name           ", (): void => {
        const boundEventAnalyses = [
            {
                ...boundEventAnalysisFixture,
                name: "someName" as Name<Bound>,
    ...
    it("returns false when the bound events contain no events which have either the same name or the same JI notation level", (): void => {
        const boundEventAnalyses = [
            {
                ...boundEventAnalysisFixture,
                name: "someName" as Name<Bound>,
