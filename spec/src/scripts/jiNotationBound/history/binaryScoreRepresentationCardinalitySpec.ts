...
describe("computeBinaryScoreRepresentationIndex", (): void => {
    it("gives the correct index for the power-of-two-based score", (): void => {
        expect(computeBinaryScoreRepresentationIndex(0 as Integer & Rank<BoundType>, 4)).toBe(0)
        expect(computeBinaryScoreRepresentationIndex(0 as Integer & Rank<BoundType>, 3)).toBe(1)
        expect(computeBinaryScoreRepresentationIndex(0 as Integer & Rank<BoundType>, 2)).toBe(2)
        expect(computeBinaryScoreRepresentationIndex(0 as Integer & Rank<BoundType>, 1)).toBe(3)
        expect(computeBinaryScoreRepresentationIndex(0 as Integer & Rank<BoundType>, 0)).toBe(4)
